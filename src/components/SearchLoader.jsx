const SearchLoader = () => {
  return (
    <div className="rounded-12 text-neutral-0 text-preset-6 absolute top-16 flex h-full w-full items-center gap-50 border-1 border-neutral-700 bg-neutral-800 p-100">
      <div role="status" aria-live="polite" aria-label="Loading…">
        <div className="pointer-events-none flex items-center gap-50">
          ...
          <span className="text-neutral-0 text-preset-6">Search in progress</span>
        </div>
      </div>
    </div>
  )
